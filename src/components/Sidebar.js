      ...
      <Center display="flex" flexDirection="column">
        ...
        >
          <Box display="flex" flexDirection="column" gap="16px" padding="20px">
            ...
            <Button color="white" variant="link" justifyContent="start">
              Customers
            </Button>
            <Accordion allowMultiple>
              <AccordionItem borderStyle="none">
                ...
                <AccordionPanel borderLeft="0.1px solid #80808040" pb={4}>
                  <Flex>
                    <Link>next 7 days</Link>
                  </Flex>
                  <Flex>
                    <Link>next 15 days</Link>
                  </Flex>
                  <Flex>
                    <Link>next 30 days</Link>
                  </Flex>
                  <Flex>
                    <Link>next 45 days</Link>
                  </Flex>
                  <Flex>
                    <Link>next 60 days</Link>
                  </Flex>
                </AccordionPanel>
              </AccordionItem>
              <AccordionItem borderStyle="none">
